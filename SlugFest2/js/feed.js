 ...
 */
async function createSlime(slimeData) {
 ...
 */
 function timeElapsed(created_at){
    ...
    if (Math.floor((currentTime - timePosted) < 3600000)){ // post is less than an hour old
        return "less than " + Math.floor((currentTime - timePosted) / 3600000) + "H"
    } else if (Math.floor((currentTime - timePosted) <= 86400000)){ // post is less than a day old
        return Math.floor((currentTime - timePosted) / 3600000) + "H"
    } else if (Math.floor((currentTime - timePosted) <= 31536000000)){ // post is less that a year old
        return Math.floor((currentTime - timePosted) / 86400000) + "D"
    } else {
        return Math.floor((currentTime - timePosted) / 31536000000) + "Y" // post is a year or more old
    }
}
